    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('agent', 'Agent'), ('underwriter', 'Underwriter'), ('finance', 'Finance'), ('operations', 'Operations')], default='agent', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agent_code', models.CharField(blank=True, max_length=20, unique=True)),
